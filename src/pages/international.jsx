      ...
      <div id="sidebar-wrapper" className={isToggled ? "open" : ""}>
        ...
        <div className={`border-end bg-white ${isToggled ? 'sb-sidenav-toggled' : ''}`} id="sidebar-content">
          <div className="sidebarTitleContainer">
            <div className="sidebar-heading border-bottom bg-light internationalTitle">
              International<img className="internationalImage" src={internationalImage} alt="icon image of a house" />
            </div>
          </div>
